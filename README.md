...
- `sglTipologia`: ART_I | ART_E | LIB | CAP_LIB | PI | IG
...
# Prototipo Industrial (NUEVO v1.1.0)
GET https://scienti.minciencias.gov.co/gruplac/json/Verificador/query.do?nroIdGrupo=00000000002096&sglTipologia=PI

# Innovaciones en Gestión Empresarial (NUEVO v1.1.0)
GET https://scienti.minciencias.gov.co/gruplac/json/Verificador/query.do?nroIdGrupo=00000000002096&sglTipologia=IG
```
...
- **Cards interactivas** por cada categoría:
  ...
  - 🏭 Prototipo Industrial ⭐ *v1.1.0*
  - 💡 Innovaciones Empresariales ⭐ *v1.1.0*
...
- **PI** (Prototipo Industrial): Datos disponibles ⭐ *v1.1.0*
- **IG** (Innovaciones Empresariales): Datos disponibles ⭐ *v1.1.0*
...
**🏫 Institución**: Universidad Católica Luis Amigó (UCEVA)  
