...
class _IngresosScreenState extends State<IngresosScreen> {
  ...
  Future<void> _loadIngresos() async {
    ...
    try {
      ...
      final ingresos = await _easySaveService.getIngresos(userId);
  ...
  Future<void> _showAddIngresoDialog() async {
    final formKey = GlobalKey<FormState>();
    final nombreController = TextEditingController();
    final valorController = TextEditingController();
    String estadoIngreso = 'fijo';
    ...
    if (result == true && mounted) {
      try {
        ...
        await _easySaveService.createIngreso(_userId!, ingreso);
  ...
  Future<void> _deleteIngreso(Ingreso ingreso) async {
    ...
    if (confirm == true && mounted) {
      try {
        await _easySaveService.deleteIngreso(ingreso.id!);
